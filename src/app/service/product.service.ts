...
export class ProductService {
    list: Product[] = [
        ...
        { id: 25, name: "Tulassay Tivadar", description: "Cím: Gyermekorvosi differenciáldiagnosztika , Év: 2020, Kiadó: Medicina Könyvkiadó", catId: 1, image: "assets/img/orvostudomany/tulassaytivadar-gyermekorvosidifferencialdiagnosztika.jpg", price: 10, stock: 5, featured: false, active: true },
        ...
        { id: 46, name: "Dr. Pattantyús Á. Géza", description: "Cím: Gépész- és villamosmérnökök kézikönyve 1, Év: 1971, Kiadó: Műszaki Könyvkiadó", catId: 1, image: "assets/img/termeszettudomany-villamosmernok/drpattantyúsgeza-gepeszesvillamosmernokokkezikonyve.jpg", price: 10, stock: 5, featured: false, active: true },

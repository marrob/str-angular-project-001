...
export class ProductService {
    list: Product[] = [
        ...
        { id: 19, name: "Dr.Tóth László", description: "Cím: Pszichológia a tanításban, Év: 2013, Kiadó: Pedellus Tankönyvkiadó", catId: 4, image: "assets/img/pedagogiapszichologia/drtothlaszlo-pszichologiaatanitasban.jpg", price: 10, stock: 5, featured: true, active: true },
        ...
        { id: 25, name: "Tulassay Tivadar", description: "Cím: Gyermekorvosi differenciál diagnosztika , Év: 2020, Kiadó: Medicina Könyvkiadó", catId: 5, image: "assets/img/orvostudomany/tulassaytivadar-gyermekorvosidifferencialdiagnosztika.jpg", price: 10, stock: 5, featured: false, active: true },
        ...
        { id: 46, name: "Dr. Pattantyús Á. Géza", description: "Cím: Gépész- és villamos mérnökök kézikönyve 1, Év: 1971, Kiadó: Műszaki Könyvkiadó", catId: 0, image: "assets/img/termeszettudomany-villamosmernok/drpattantyúsgeza-gepeszesvillamosmernokokkezikonyve.jpg", price: 10, stock: 5, featured: false, active: true },
